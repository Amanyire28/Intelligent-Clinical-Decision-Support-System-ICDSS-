...
switch ($page) {
    ...
    case 'api-historical-insights':
        ...
        try {
            ...
            if (!$assessmentId) {
                echo json_encode(['success' => false, 'message' => 'No assessment ID provided']);
                exit;
            }
            ...
            error_log("Historical Insights Error: " . $e->getMessage());
            echo json_encode(['success' => false, 'message' => 'Error loading historical insights: ' . $e->getMessage()]);
        }
        exit;
        break;
