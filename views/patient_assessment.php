            ...
            <aside class="sidebar">
                <div class="nav-section">
                    ...
                    <ul class="nav-list">
                        ...
                        <li><a href="<?php echo BASE_URL; ?>/index.php?page=patient-assessment" class="nav-link active">New Assessment</a></li>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="<?php echo BASE_URL; ?>/index.php?page=doctor-dashboard" class="btn btn-secondary">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
