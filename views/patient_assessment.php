...
<body>
        ...
        <nav class="navbar navbar-main">
            <div class="navbar-brand">
                <h1 class="system-title">
                    <span class="title-icon">⚕️</span> ICDSS - New Patient Assessment
                </h1>
            </div>
        ...
        <div class="main-content">
            ...
            <section class="content-panel">
                <div class="dashboard-header">
                    <h2>Throat Cancer Risk Assessment</h2>
                    <p class="subtitle">Comprehensive patient evaluation form</p>
                </div>
                ...
                <div class="panel panel-primary">
                    <div class="panel-header">
                        ...
                        <p class="panel-description">Complete all sections for accurate risk scoring</p>
                    </div>
    ...
    <script>
        // Show/hide weight loss details based on checkbox
        document.getElementById('weight_loss').addEventListener('change', function() {
            document.getElementById('weight_loss_details').style.display = this.checked ? 'block' : 'none';
        });

        // Show/hide smoking years based on selection
        ...
        // Show/hide family cancer details based on checkbox
        document.getElementById('family_cancer_history').addEventListener('change', function() {
            document.getElementById('family_cancer_details').style.display = this.checked ? 'block' : 'none';
        });
    </script>
</body>
</html>
